    ...
    extends HeaderScrollingViewBehavior
  {
    ...
    private void offsetChildAsNeeded(CoordinatorLayout paramCoordinatorLayout, View paramView1, View paramView2)
    {
      ...
      if ((paramCoordinatorLayout instanceof AppBarLayout.Behavior))
      {
        ...
        paramView1.offsetTopAndBottom(paramView2.getBottom() - paramView1.getTop() + paramCoordinatorLayout.mOffsetDelta + getVerticalLayoutGap() - getOverlapPixelsForOffset(paramView2));
      }
    }
...
/* Location:              C:\Users\colin\Documents\GitHub\cchr158First\G7.jar!\android\support\design\widget\AppBarLayout.class
