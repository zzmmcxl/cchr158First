...
public final class AppCompatDrawableManager
{
  ...
  private boolean addCachedDelegateDrawable(@NonNull Context paramContext, long paramLong, @NonNull Drawable paramDrawable)
  {
    ...
    if (localConstantState != null) {
      ...
      {
        LongSparseArray localLongSparseArray = (LongSparseArray)this.mDelegateDrawableCaches.get(paramContext);
        paramDrawable = localLongSparseArray;
        if (localLongSparseArray == null)
        {
          paramDrawable = new LongSparseArray();
          this.mDelegateDrawableCaches.put(paramContext, paramDrawable);
        }
  ...
  private Drawable getCachedDelegateDrawable(@NonNull Context paramContext, long paramLong)
  {
    ...
    synchronized (this.mDelegateDrawableCacheLock)
    {
      localLongSparseArray = (LongSparseArray)this.mDelegateDrawableCaches.get(paramContext);
      if (localLongSparseArray == null) {
        return null;
      }
  ...
  private Drawable loadDrawableFromDelegates(@NonNull Context paramContext, @DrawableRes int paramInt)
  {
    if ((this.mDelegates != null) && (!this.mDelegates.isEmpty()))
    {
      ...
      do
      {
        ...
        l = localTypedValue.assetCookie << 32 | localTypedValue.data;
        localObject1 = getCachedDelegateDrawable(paramContext, l);
      ...
      for (;;)
      {
        ...
        if (localObject2 != null)
        {
          ...
          localObject3 = localObject2;
          boolean bool = addCachedDelegateDrawable(paramContext, l, (Drawable)localObject2);
          localObject3 = localObject2;
          if (bool) {
            localObject3 = localObject2;
          }
  ...
  private Drawable tintDrawable(@NonNull Context paramContext, @DrawableRes int paramInt, boolean paramBoolean, @NonNull Drawable paramDrawable)
  {
    ...
    for (;;)
    {
      ...
      else if ((paramInt == R.drawable.abc_ratingbar_indicator_material) || (paramInt == R.drawable.abc_ratingbar_small_material))
      {
        localObject = (LayerDrawable)paramDrawable;
...
/* Location:              C:\Users\colin\Documents\GitHub\cchr158First\G7.jar!\android\support\v7\widget\AppCompatDrawableManager.class
