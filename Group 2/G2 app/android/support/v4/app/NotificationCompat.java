...
public class NotificationCompat {
   ...
   static class NotificationCompatImplBase implements NotificationCompat.NotificationCompatImpl {
      public Notification build(NotificationCompat.Builder var1, NotificationCompat.BuilderExtender var2) {
         Notification var3 = var1.mNotification;
         var3.setLatestEventInfo(var1.mContext, var1.mContentTitle, var1.mContentText, var1.mContentIntent);
         if(var1.mPriority > 0) {
            var3.flags |= 128;
         }
   ...
   static class NotificationCompatImplGingerbread extends NotificationCompat.NotificationCompatImplBase {
      public Notification build(NotificationCompat.Builder var1, NotificationCompat.BuilderExtender var2) {
         Notification var3 = var1.mNotification;
         var3.setLatestEventInfo(var1.mContext, var1.mContentTitle, var1.mContentText, var1.mContentIntent);
         var3 = NotificationCompatGingerbread.add(var3, var1.mContext, var1.mContentTitle, var1.mContentText, var1.mContentIntent, var1.mFullScreenIntent);
         if(var1.mPriority > 0) {
            var3.flags |= 128;
         }
