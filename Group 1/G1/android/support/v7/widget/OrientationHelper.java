...
public abstract class OrientationHelper
{
    ...
    OrientationHelper(final RecyclerView.LayoutManager layoutManager, final OrientationHelper$1 orientationHelper) {
        this(layoutManager);
    }
    ...
    public int getTotalSpaceChange() {
        ...
        return this.getTotalSpace() - mLastTotalSpace;
    }
    ...
    public void onLayoutComplete() {
        mLastTotalSpace = this.getTotalSpace();
    }
}
