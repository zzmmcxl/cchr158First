...
public class AppCompatRatingBar extends RatingBar
{
    ...
    public AppCompatRatingBar(final Context context, final AttributeSet set, final int n) {
        ...
        (mAppCompatProgressBarHelper = new AppCompatProgressBarHelper((ProgressBar)this, mDrawableManager)).loadFromAttributes(set, n);
    }
    
    protected void onMeasure(final int n, final int n2) {
        synchronized (this) {
            super.onMeasure(n, n2);
            final Bitmap sampleTime = mAppCompatProgressBarHelper.getSampleTime();
            if (sampleTime != null) {
