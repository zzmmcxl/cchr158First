...
extends mm {
    ...
    public boolean equals(Object object) {
        ...
        lo lo2 = (lo)object;
        if (this.a == null ? lo2.a != null : !this.a.equals(lo2.a)) {
            return false;
        }
        if (this.b == null ? lo2.b != null : !this.b.equals(lo2.b)) {
            return false;
        }
        if (this.c == null ? lo2.c != null : !this.c.equals(lo2.c)) {
            return false;
        }
        if (this.d == null) {
            if (lo2.d == null) return true;
            return false;
        }
        if (this.d.equals(lo2.d)) return true;
        return false;
    }
