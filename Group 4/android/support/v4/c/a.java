...
public final class a {
    ...
    private static int a(int n2, int n3, int n4, int n5, int n6) {
        if (n6 != 0) return (n3 * (n2 * 255) + n4 * n5 * (255 - n3)) / (n6 * 255);
        return 0;
    }

    public static int b(int n2, int n3) {
        if (n3 < 0) throw new IllegalArgumentException("alpha must be between 0 and 255.");
        if (n3 <= 255) return 16777215 & n2 | n3 << 24;
