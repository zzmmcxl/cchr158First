...
extends a {
    ...
    public au(Resources resources, Drawable drawable, float f2, float f3, float f4) {
        super(drawable);
        this.l = resources.getColor(d.design_fab_shadow_start_color);
        this.m = resources.getColor(d.design_fab_shadow_mid_color);
        this.n = resources.getColor(d.design_fab_shadow_end_color);
        this.b = new Paint(5);
    ...
    public boolean getPadding(Rect rect) {
        int n2 = (int)Math.ceil(au.a(this.h, this.e, this.o));
        int n3 = (int)Math.ceil(au.b(this.h, this.e, this.o));
