...
import android.support.v4.media.IMediaBrowserServiceCallbacksAdapterApi21$Stub;

abstract class IMediaBrowserServiceAdapterApi21$Stub extends Binder implements IInterface {
   ...
   public boolean onTransact(int var1, Parcel var2, Parcel var3, int var4) throws RemoteException {
      ...
      case 1:
         ...
         this.connect(var5, var8, IMediaBrowserServiceCallbacksAdapterApi21$Stub.asInterface(var2.readStrongBinder()));
         return true;
      case 2:
         var2.enforceInterface("android.service.media.IMediaBrowserService");
