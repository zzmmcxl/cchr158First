...
import android.support.v4.widget.ExploreByTouchHelper$1;
...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
   ...
   private AccessibilityNodeInfoCompat createNodeForHost() {
      ...
      this.onPopulateNodeForHost(var1);
   ...
   public AccessibilityNodeProviderCompat getAccessibilityNodeProvider(View var1) {
      if(this.mNodeProvider == null) {
         this.mNodeProvider = new ExploreByTouchHelper$ExploreByTouchNodeProvider(this, (ExploreByTouchHelper$1)null);
      }
   ...
   public void onPopulateNodeForHost(AccessibilityNodeInfoCompat var1) {
   }
