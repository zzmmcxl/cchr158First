         ...
         if(var0.getItemCount() != 0) {
            ...
            if(var2 != null) {
               if(var3 == null) {
                  ...
                  int var11 = Math.min(var4.getPosition(var2), var4.getPosition(var3));
                  var9 = Math.max(var4.getPosition(var2), var4.getPosition(var3));
                  if(var6) {
                     var11 = Math.max(0, var0.getItemCount() - var9 - 1);
                  } else {
                  ...
                  if(var5) {
                     ...
                     return Math.round((float)var11 * var7 + (float)(var1.getStartAfterPadding() - var1.getDecoratedStart(var2)));
                  }
               }
            }
         }
