...
import android.support.v7.widget.ShareActionProvider$1;
import android.support.v7.widget.ShareActionProvider$OnShareTargetSelectedListener;
import android.support.v7.widget.ShareActionProvider$ShareActivityChooserModelPolicy;
import android.support.v7.widget.ShareActionProvider$ShareMenuItemOnMenuItemClickListener;
...
public class ShareActionProvider extends ActionProvider {
   ...
   private final ShareActionProvider$ShareMenuItemOnMenuItemClickListener mOnMenuItemClickListener = new ShareActionProvider$ShareMenuItemOnMenuItemClickListener(this, (ShareActionProvider$1)null);
   ...
   private void setActivityChooserPolicyIfNeeded() {
      if(this.mOnShareTargetSelectedListener != null) {
         if(this.mOnChooseActivityListener == null) {
            this.mOnChooseActivityListener = new ShareActionProvider$ShareActivityChooserModelPolicy(this, (ShareActionProvider$1)null);
         }
