...
import android.support.v7.view.menu.ActionMenuItemView$ActionMenuItemForwardingListener;
...
public class ActionMenuItemView extends AppCompatTextView implements MenuView$ItemView, OnClickListener, OnLongClickListener, ActionMenuView$ActionMenuChildView {
   ...
   public boolean onLongClick(View var1) {
      if(this.hasText()) {
         ...
         this.getWindowVisibleDisplayFrame(var8);
         Context var9 = this.getContext();
         int var2 = this.getWidth();
         int var4 = this.getHeight();
         int var5 = var7[1];
         int var6 = var4 / 2;
         int var3 = var7[0] + var2 / 2;
         var2 = var3;
         ...
         if(var5 + var6 < var8.height()) {
            var10.setGravity(8388661, var2, var7[1] + var4 - var8.top);
         } else {
