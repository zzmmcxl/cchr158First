...
import android.support.design.widget.FloatingActionButtonImpl$1;
...
abstract class FloatingActionButtonImpl {
   ...
   private void ensurePreDrawListener() {
      if(this.mPreDrawListener == null) {
         this.mPreDrawListener = new FloatingActionButtonImpl$1(this);
      }
   ...
   CircularBorderDrawable createBorderDrawable(int var1, ColorStateList var2) {
      ...
      var4.setGradientColors(var3.getColor(R$color.design_fab_stroke_top_outer_color), var3.getColor(R$color.design_fab_stroke_top_inner_color), var3.getColor(R$color.design_fab_stroke_end_inner_color), var3.getColor(R$color.design_fab_stroke_end_outer_color));
