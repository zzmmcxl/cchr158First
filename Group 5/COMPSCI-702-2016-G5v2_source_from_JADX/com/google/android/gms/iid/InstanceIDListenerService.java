...
public class InstanceIDListenerService extends Service {
    ...
    class C03741 extends Handler {
        ...
        C03741(InstanceIDListenerService instanceIDListenerService, Looper looper) {
    ...
    class C03752 extends BroadcastReceiver {
        final /* synthetic */ InstanceIDListenerService zzaNc;

        C03752(InstanceIDListenerService instanceIDListenerService) {
            this.zzaNc = instanceIDListenerService;
        }
    ...
    public InstanceIDListenerService() {
        this.zzaMW = new MessengerCompat(new C03741(this, Looper.getMainLooper()));
        this.zzaMX = new C03752(this);
    }
