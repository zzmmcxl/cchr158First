...
public final class zzb {
    ...
    public static class zzc {
        public long zzC(long j) {
            return (long) (TimeZone.getDefault().getOffset(j) / GeofenceStatusCodes.GEOFENCE_NOT_AVAILABLE);
        }
    }

    /* renamed from: com.google.android.gms.clearcut.zzb.1 */
    static class C07371 extends com.google.android.gms.common.api.Api.zza<zzlw, NoOptions> {
        C07371() {
        }
