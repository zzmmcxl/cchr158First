...
public class zzad {
    ...
    public zzad(int i, long j, String str, zzmq com_google_android_gms_internal_zzmq) {
    ...
    public zzad(String str, zzmq com_google_android_gms_internal_zzmq) {
        this(60, 2000, str, com_google_android_gms_internal_zzmq);
    }
