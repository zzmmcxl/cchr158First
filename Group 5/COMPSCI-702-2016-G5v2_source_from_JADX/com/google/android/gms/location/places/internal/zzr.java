...
public class zzr extends zzt implements Place {
    ...
    public zzr(DataHolder dataHolder, int i, Context context) {
        super(dataHolder, i);
        this.zzaPH = zzG("place_id", BuildConfig.FLAVOR);
    }
    ...
    public CharSequence getAddress() {
        return zzG("place_address", BuildConfig.FLAVOR);
    }
    ...
    public Locale getLocale() {
        Object zzG = zzG("place_locale", BuildConfig.FLAVOR);
        return !TextUtils.isEmpty(zzG) ? new Locale(zzG) : Locale.getDefault();
    }

    public CharSequence getName() {
        return zzG("place_name", BuildConfig.FLAVOR);
    }

    public CharSequence getPhoneNumber() {
        return zzG("place_phone_number", BuildConfig.FLAVOR);
    }
