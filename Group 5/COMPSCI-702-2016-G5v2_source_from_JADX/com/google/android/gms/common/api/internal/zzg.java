...
public class zzg implements zzk {
    ...
    class C07421 extends zza {
        final /* synthetic */ zzg zzahl;

        C07421(zzg com_google_android_gms_common_api_internal_zzg, zzk com_google_android_gms_common_api_internal_zzk) {
    ...
    class C07432 extends zza {
        final /* synthetic */ zzg zzahl;

        C07432(zzg com_google_android_gms_common_api_internal_zzg, zzk com_google_android_gms_common_api_internal_zzk) {
            this.zzahl = com_google_android_gms_common_api_internal_zzg;
            super(com_google_android_gms_common_api_internal_zzk);
        }
    ...
    public void connect() {
        if (this.zzahk) {
            this.zzahk = false;
            this.zzahj.zza(new C07432(this, this));
        }
    }
    ...
    public <A extends zzb, T extends zza<? extends Result, A>> T zzb(T t) {
        try {
            ...
            this.zzahj.zza(new C07421(this, this));
        }
        return t;
    }
