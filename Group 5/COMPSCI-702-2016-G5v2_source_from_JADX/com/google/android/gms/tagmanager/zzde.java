...
class zzde extends Number implements Comparable<zzde> {
    ...
    public int zza(zzde com_google_android_gms_tagmanager_zzde) {
        return (zzHv() && com_google_android_gms_tagmanager_zzde.zzHv()) ? new Long(this.zzblC).compareTo(Long.valueOf(com_google_android_gms_tagmanager_zzde.zzblC)) : Double.compare(doubleValue(), com_google_android_gms_tagmanager_zzde.doubleValue());
    }
}
