...
public class zzir {
    ...
    class C04531 implements Runnable {
        ...
        C04531(zzir com_google_android_gms_internal_zzir, Context context) {
    ...
    public float zzbt() {
        ...
        return (zzbs == null || !zzbs.zzbu()) ? TextTrackStyle.DEFAULT_FONT_SCALE : zzbs.zzbt();
    }
    ...
    public Bitmap zzf(Context context, String str) {
        ...
        try {
            ...
            zzb.m9e("Fail to get background image");
            return null;
        }
    }
