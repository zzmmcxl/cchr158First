...
class zzjt extends WebView implements OnGlobalLayoutListener, DownloadListener, zzjp {
    ...
    class C04631 implements Runnable {
        ...
        C04631(zzjt com_google_android_gms_internal_zzjt) {
    ...
    public void destroy() {
        synchronized (this.zzpV) {
            ...
            zzit();
            this.zzNT = true;
            zzin.m27v("Initiating WebView self destruct sequence in 3...");
            this.zzNQ.zzii();
        }
    }
    ...
    public void zzb(String str, JSONObject jSONObject) {
        ...
        stringBuilder.append(");");
        zzin.m27v("Dispatching AFMA event: " + stringBuilder.toString());
    ...
    public void zzhZ() {
        synchronized (this.zzpV) {
            zzin.m27v("Destroying WebView!");
            zzir.zzMc.post(new C04631(this));
        }
    }
