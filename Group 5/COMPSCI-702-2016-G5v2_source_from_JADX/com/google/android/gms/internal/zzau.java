...
public abstract class zzau implements OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    class C03791 extends BroadcastReceiver {
        final /* synthetic */ zzau zzsp;

        C03791(zzau com_google_android_gms_internal_zzau) {
    ...
    class C07782 implements zzdf {
        final /* synthetic */ zzau zzsp;

        C07782(zzau com_google_android_gms_internal_zzau) {
            this.zzsp = com_google_android_gms_internal_zzau;
        }
    ...
    class C07793 implements zzdf {
        final /* synthetic */ zzau zzsp;

        C07793(zzau com_google_android_gms_internal_zzau) {
            this.zzsp = com_google_android_gms_internal_zzau;
        }
    ...
    class C07804 implements zzdf {
        final /* synthetic */ zzau zzsp;

        C07804(zzau com_google_android_gms_internal_zzau) {
            this.zzsp = com_google_android_gms_internal_zzau;
        }
    ...
    public zzau(Context context, AdSizeParcel adSizeParcel, zzif com_google_android_gms_internal_zzif, VersionInfoParcel versionInfoParcel, zzbb com_google_android_gms_internal_zzbb) {
        ...
        this.zzsm = new C07782(this);
        this.zzsn = new C07793(this);
        this.zzso = new C07804(this);
