...
public class zzfp extends zzfs {
    ...
    class C04261 implements OnClickListener {
        ...
        C04261(zzfp com_google_android_gms_internal_zzfp, String str, String str2) {
    ...
    class C04272 implements OnClickListener {
        ...
        C04272(zzfp com_google_android_gms_internal_zzfp) {
            this.zzDt = com_google_android_gms_internal_zzfp;
        }
        ...
        if (this.mContext == null) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                if (zzr.zzbC().zzaE(zzal)) {
                    ...
                    zzL.setTitle(zzr.zzbF().zzd(C0230R.string.store_picture_title, "Save image"));
                    zzL.setMessage(zzr.zzbF().zzd(C0230R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
                    zzL.setPositiveButton(zzr.zzbF().zzd(C0230R.string.accept, "Accept"), new C04261(this, str, zzal));
                    zzL.setNegativeButton(zzr.zzbF().zzd(C0230R.string.decline, "Decline"), new C04272(this));
                    zzL.create().show();
                    return;
                }
