...
public class zzdg implements zzdf {
    ...
    class C03901 implements Runnable {
        ...
        class C03891 implements Runnable {
            ...
            final /* synthetic */ C03901 zzzo;

            C03891(C03901 c03901, JSONObject jSONObject) {
                this.zzzo = c03901;
        ...
        C03901(zzdg com_google_android_gms_internal_zzdg, Map map, zzjp com_google_android_gms_internal_zzjp) {
        ...
        public void run() {
            ...
            if (zzQ == null) {
                ...
                zzir.zzMc.post(new C03891(this, zzQ));
            }
        }
    }
    ...
    public JSONObject zzQ(String str) {
        try {
            ...
            com.google.android.gms.ads.internal.util.client.zzb.m9e("The request is not a valid JSON.");
            try {
    ...
    public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
        zziq.zza(new C03901(this, map, com_google_android_gms_internal_zzjp));
    }
