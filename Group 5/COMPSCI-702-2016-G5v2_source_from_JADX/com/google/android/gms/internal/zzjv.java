...
public class zzjv extends WebChromeClient {
    ...
    static class C04641 implements OnCancelListener {
        final /* synthetic */ JsResult zzOh;

        C04641(JsResult jsResult) {
            this.zzOh = jsResult;
        }
    ...
    static class C04652 implements OnClickListener {
        final /* synthetic */ JsResult zzOh;

        C04652(JsResult jsResult) {
            this.zzOh = jsResult;
        }
    ...
    static class C04663 implements OnClickListener {
        final /* synthetic */ JsResult zzOh;

        C04663(JsResult jsResult) {
            this.zzOh = jsResult;
        }
    ...
    static class C04674 implements OnCancelListener {
        final /* synthetic */ JsPromptResult zzOi;

        C04674(JsPromptResult jsPromptResult) {
    ...
    static class C04685 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzOi;

        C04685(JsPromptResult jsPromptResult) {
            this.zzOi = jsPromptResult;
        }
    ...
    static class C04696 implements OnClickListener {
        final /* synthetic */ JsPromptResult zzOi;
        final /* synthetic */ EditText zzOj;

        C04696(JsPromptResult jsPromptResult, EditText editText) {
            this.zzOi = jsPromptResult;
            this.zzOj = editText;
        }
    ...
    private static void zza(Builder builder, String str, JsResult jsResult) {
        builder.setMessage(str).setPositiveButton(17039370, new C04663(jsResult)).setNegativeButton(17039360, new C04652(jsResult)).setOnCancelListener(new C04641(jsResult)).create().show();
    }
    ...
    private static void zza(Context context, Builder builder, String str, String str2, JsPromptResult jsPromptResult) {
        ...
        builder.setView(linearLayout).setPositiveButton(17039370, new C04696(jsPromptResult, editText)).setNegativeButton(17039360, new C04685(jsPromptResult)).setOnCancelListener(new C04674(jsPromptResult)).create().show();
    }
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        switch (C04707.zzOk[consoleMessage.messageLevel().ordinal()]) {
