...
public final class zzmh implements zzmg {
    ...
    class C12451 extends zza {
        final /* synthetic */ zzmh zzamB;

        C12451(zzmh com_google_android_gms_internal_zzmh, GoogleApiClient googleApiClient) {
    ...
    public PendingResult<Status> zzf(GoogleApiClient googleApiClient) {
        return googleApiClient.zzb(new C12451(this, googleApiClient));
    }
}
