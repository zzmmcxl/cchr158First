...
public class zzht extends zzb implements zzhw {
    ...
    class C04421 implements Runnable {
        ...
        C04421(zzht com_google_android_gms_internal_zzht, zza com_google_android_gms_internal_zzif_zza) {
    ...
    private zza zzc(zza com_google_android_gms_internal_zzif_zza) {
        zzin.m27v("Creating mediation ad response for non-mediated rewarded ad.");
        try {
    ...
    public void zza(zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
        if (com_google_android_gms_internal_zzif_zza.errorCode != -2) {
            zzir.zzMc.post(new C04421(this, com_google_android_gms_internal_zzif_zza));
            return;
        }
