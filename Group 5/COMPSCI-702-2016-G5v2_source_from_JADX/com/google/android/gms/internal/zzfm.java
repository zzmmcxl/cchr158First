...
public class zzfm extends zzfs {
    ...
    class C04231 implements OnClickListener {
        ...
        C04231(zzfm com_google_android_gms_internal_zzfm) {
    ...
    class C04242 implements OnClickListener {
        ...
        C04242(zzfm com_google_android_gms_internal_zzfm) {
            this.zzCZ = com_google_android_gms_internal_zzfm;
        }
    ...
    public void execute() {
        if (this.mContext == null) {
            ...
            zzL.setTitle(zzr.zzbF().zzd(C0230R.string.create_calendar_title, "Create calendar event"));
            zzL.setMessage(zzr.zzbF().zzd(C0230R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
            zzL.setPositiveButton(zzr.zzbF().zzd(C0230R.string.accept, "Accept"), new C04231(this));
            zzL.setNegativeButton(zzr.zzbF().zzd(C0230R.string.decline, "Decline"), new C04242(this));
            zzL.create().show();
        } else {
