...
public class zzbf extends Thread {
    ...
    class C03801 implements Runnable {
        ...
        C03801(zzbf com_google_android_gms_internal_zzbf, View view) {
    ...
    class C03822 implements Runnable {
        ...
        class C03811 implements ValueCallback<String> {
            final /* synthetic */ C03822 zztl;

            C03811(C03822 c03822) {
                this.zztl = c03822;
            }
        ...
        C03822(zzbf com_google_android_gms_internal_zzbf, zzbc com_google_android_gms_internal_zzbc, WebView webView, boolean z) {
            this.zztg = com_google_android_gms_internal_zzbf;
            this.zzti = com_google_android_gms_internal_zzbc;
            this.zztj = webView;
            this.zztk = z;
            this.zzth = new C03811(this);
        }
    ...
    boolean zza(WebView webView, zzbc com_google_android_gms_internal_zzbc, boolean z) {
        ...
        com_google_android_gms_internal_zzbc.zzcC();
        webView.post(new C03822(this, com_google_android_gms_internal_zzbc, webView, z));
        return true;
    }
    ...
    boolean zze(View view) {
        ...
        view.post(new C03801(this, view));
        return true;
    }
