...
public final class zzbt {
    ...
    static class C03861 implements Callable<Void> {
        final /* synthetic */ Context zzxh;

        C03861(Context context) {
            this.zzxh = context;
        }
    ...
    static {
        ...
        zzvP = zzbp.zza(0, "gads:video_stream_cache:limit_space", (int) MediaRouterJellybean.ROUTE_TYPE_USER);
        zzvQ = zzbp.zza(0, "gads:video_stream_exo_cache:buffer_size", (int) MediaRouterJellybean.ROUTE_TYPE_USER);
        ...
        zzvT = zzbp.zza(0, "gads:video_stream_cache:connect_timeout_millis", (int) StatusCodes.AUTH_DISABLED);
        ...
        zzwX = zzbp.zza(0, "gads:ad_loader:timeout_ms", 60000);
        zzwY = zzbp.zza(0, "gads:rendering:timeout_ms", 60000);
