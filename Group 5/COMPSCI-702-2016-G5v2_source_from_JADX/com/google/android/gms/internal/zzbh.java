...
public class zzbh {
    ...
    class C03831 implements Comparator<String> {
        final /* synthetic */ zzbh zztt;

        C03831(zzbh com_google_android_gms_internal_zzbh) {
    ...
    class C03842 implements Comparator<com.google.android.gms.internal.zzbk.zza> {
        final /* synthetic */ zzbh zztt;

        C03842(zzbh com_google_android_gms_internal_zzbh) {
            this.zztt = com_google_android_gms_internal_zzbh;
        }
    ...
    static class zza {
        ...
        public zza() {
            this.zztu = new ByteArrayOutputStream(Barcode.AZTEC);
    ...
    private String zzv(String str) {
        ...
        zza zzcM = zzcM();
        Arrays.sort(split, new C03831(this));
        int i = 0;
    ...
    String zzw(String str) {
        ...
        zza zzcM = zzcM();
        PriorityQueue priorityQueue = new PriorityQueue(this.zztq, new C03842(this));
