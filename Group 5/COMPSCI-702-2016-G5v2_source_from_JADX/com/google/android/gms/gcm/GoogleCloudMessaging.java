...
public class GoogleCloudMessaging {
    ...
    class C03671 extends Handler {
        ...
        C03671(GoogleCloudMessaging googleCloudMessaging, Looper looper) {
    ...
    public GoogleCloudMessaging() {
        ...
        this.zzaLU = new Messenger(new C03671(this, Looper.getMainLooper()));
    }
    ...
    private String zzdZ(String str) {
        ...
        return InstanceID.getInstance(this.context).zzyB().zzi(BuildConfig.FLAVOR, str, INSTANCE_ID_SCOPE);
    }
