...
public abstract class GcmListenerService extends Service {
    ...
    class C03651 implements Runnable {
        ...
        C03651(GcmListenerService gcmListenerService, Intent intent) {
    ...
    class C03662 extends AsyncTask<Void, Void, Void> {
        final /* synthetic */ Intent val$intent;
        final /* synthetic */ GcmListenerService zzaLA;

        C03662(GcmListenerService gcmListenerService, Intent intent) {
            this.zzaLA = gcmListenerService;
            this.val$intent = intent;
        }
    ...
    private void zzn(Intent intent) {
        if (VERSION.SDK_INT >= 11) {
            AsyncTask.THREAD_POOL_EXECUTOR.execute(new C03651(this, intent));
        } else {
            new C03662(this, intent).execute(new Void[0]);
        }
    }
