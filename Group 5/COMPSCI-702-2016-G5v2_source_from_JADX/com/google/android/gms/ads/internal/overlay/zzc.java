...
public class zzc extends zzi implements OnAudioFocusChangeListener, OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnVideoSizeChangedListener, SurfaceTextureListener {
    ...
    class C02401 implements Runnable {
        ...
        C02401(zzc com_google_android_gms_ads_internal_overlay_zzc) {
    ...
    class C02412 implements Runnable {
        ...
        C02412(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02423 implements Runnable {
        ...
        C02423(zzc com_google_android_gms_ads_internal_overlay_zzc, String str, String str2) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
            this.zzEe = str;
            this.zzEf = str2;
        }
    ...
    class C02434 implements Runnable {
        ...
        C02434(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02445 implements Runnable {
        ...
        C02445(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02456 implements Runnable {
        final /* synthetic */ zzc zzEd;

        C02456(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    class C02467 implements Runnable {
        final /* synthetic */ zzc zzEd;

        C02467(zzc com_google_android_gms_ads_internal_overlay_zzc) {
            this.zzEd = com_google_android_gms_ads_internal_overlay_zzc;
        }
    ...
    public zzc(Context context, zzt com_google_android_gms_ads_internal_overlay_zzt) {
        ...
        this.zzDP = 0;
        this.zzDQ = 0;
        this.zzDY = TextTrackStyle.DEFAULT_FONT_SCALE;
    ...
    private void zzfa() {
        Throwable e;
        zzin.m27v("AdMediaPlayerView init MediaPlayer");
    ...
    private void zzfb() {
        if (zzfe() && this.zzDR.getCurrentPosition() > 0 && this.zzDQ != 3) {
            zzin.m27v("AdMediaPlayerView nudging MediaPlayer");
            zzb(0.0f);
            this.zzDR.start();
    ...
    private void zzfd() {
        zzin.m27v("AdMediaPlayerView abandon audio focus");
        AudioManager zzfk = zzfk();
        if (zzfk != null && this.zzEa) {
    ...
    private void zzfh() {
        zzin.m27v("AdMediaPlayerView audio focus gained");
        this.zzEa = true;
        zzfj();
    }

    private void zzfi() {
        zzin.m27v("AdMediaPlayerView audio focus lost");
        this.zzEa = false;
        zzfj();
    }
    ...
    private void zzv(boolean z) {
        zzin.m27v("AdMediaPlayerView release");
        if (this.zzDR != null) {
            this.zzDR.reset();
            this.zzDR.release();
            this.zzDR = null;
    ...
    public void onCompletion(MediaPlayer mp) {
        zzin.m27v("AdMediaPlayerView completion");
        zzw(5);
        zzx(5);
        zzir.zzMc.post(new C02412(this));
    }
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        ...
        zzw(-1);
        zzx(-1);
        zzir.zzMc.post(new C02423(this, str, str2));
        return true;
    }

    public boolean onInfo(MediaPlayer mp, int what, int extra) {
        String str = (String) zzDN.get(Integer.valueOf(extra));
        zzin.m27v("AdMediaPlayerView MediaPlayer info: " + ((String) zzDN.get(Integer.valueOf(what))) + ":" + str);
        return true;
    }
    ...
    public void onPrepared(MediaPlayer mediaPlayer) {
        zzin.m27v("AdMediaPlayerView prepared");
        zzw(2);
        this.zzDO.zzfz();
        zzir.zzMc.post(new C02401(this));
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        zzin.m27v("AdMediaPlayerView surface created");
        zzfa();
        zzir.zzMc.post(new C02434(this));
    }

    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        zzin.m27v("AdMediaPlayerView surface destroyed");
        if (this.zzDR != null && this.zzEb == 0) {
            this.zzEb = this.zzDR.getCurrentPosition();
        }
        zzir.zzMc.post(new C02445(this));
        zzv(true);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int w, int h) {
        Object obj = 1;
        zzin.m27v("AdMediaPlayerView surface changed");
    ...
    public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
        zzin.m27v("AdMediaPlayerView size changed: " + width + " x " + height);
    ...
    public void pause() {
        zzin.m27v("AdMediaPlayerView pause");
        if (zzfe() && this.zzDR.isPlaying()) {
            this.zzDR.pause();
            zzw(4);
            zzir.zzMc.post(new C02467(this));
        }
        zzx(4);
    }

    public void play() {
        zzin.m27v("AdMediaPlayerView play");
        if (zzfe()) {
            this.zzDR.start();
            zzw(3);
            zzir.zzMc.post(new C02456(this));
        }
        zzx(3);
    }

    public void seekTo(int millis) {
        zzin.m27v("AdMediaPlayerView seek " + millis);
        if (zzfe()) {
    ...
    public void stop() {
        zzin.m27v("AdMediaPlayerView stop");
        if (this.zzDR != null) {
            this.zzDR.stop();
            this.zzDR.release();
            this.zzDR = null;
