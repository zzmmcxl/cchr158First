...
public abstract class zzd implements com.google.android.gms.ads.internal.request.zzc.zza, zzit<Void> {
    ...
    class C07011 implements zzc<AdRequestInfoParcel> {
        final /* synthetic */ zzj zzHn;
        final /* synthetic */ zzd zzHo;

        C07011(zzd com_google_android_gms_ads_internal_request_zzd, zzj com_google_android_gms_ads_internal_request_zzj) {
    ...
    class C07022 implements com.google.android.gms.internal.zzji.zza {
        final /* synthetic */ zzd zzHo;

        C07022(zzd com_google_android_gms_ads_internal_request_zzd) {
            this.zzHo = com_google_android_gms_ads_internal_request_zzd;
        }
    ...
    public Void zzga() {
        ...
        if (zzgs == null) {
            ...
            this.zzHl.zza(new C07011(this, zzgs), new C07022(this));
        }
        return null;
    }
