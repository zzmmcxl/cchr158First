...
public class zzq {
    ...
    class C02671 implements Runnable {
        ...
        C02671(zzq com_google_android_gms_ads_internal_zzq, WeakReference weakReference) {
    ...
    zzq(zza com_google_android_gms_ads_internal_zza, zza com_google_android_gms_ads_internal_zzq_zza) {
        ...
        this.zzx = new C02671(this, new WeakReference(com_google_android_gms_ads_internal_zza));
    }
