...
public class zzi implements zzh {
    ...
    class C06941 implements zzdf {
        final /* synthetic */ zzi zzyx;

        /* renamed from: com.google.android.gms.ads.internal.formats.zzi.1.1 */
        class C06931 implements zzjq.zza {
            final /* synthetic */ Map zzyy;
            final /* synthetic */ C06941 zzyz;

            C06931(C06941 c06941, Map map) {
                this.zzyz = c06941;
                this.zzyy = map;
            }
        ...
        C06941(zzi com_google_android_gms_ads_internal_formats_zzi) {
        ...
        public void zza(zzjp com_google_android_gms_internal_zzjp, Map<String, String> map) {
            this.zzyx.zzpD.zzhU().zza(new C06931(this, map));
    ...
    class C06952 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C06952(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C06963 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C06963(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C06974 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C06974(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    class C06985 implements zzdf {
        final /* synthetic */ zzi zzyx;

        C06985(zzi com_google_android_gms_ads_internal_formats_zzi) {
            this.zzyx = com_google_android_gms_ads_internal_formats_zzi;
        }
    ...
    public zzjp zzdR() {
        ...
        this.zzyr.zza("/loadHtml", new C06941(this));
        this.zzyr.zza("/showOverlay", new C06952(this));
        this.zzyr.zza("/hideOverlay", new C06963(this));
        this.zzpD.zzhU().zza("/hideOverlay", new C06974(this));
        this.zzpD.zzhU().zza("/sendMessageToSdk", new C06985(this));
        return this.zzpD;
    }
