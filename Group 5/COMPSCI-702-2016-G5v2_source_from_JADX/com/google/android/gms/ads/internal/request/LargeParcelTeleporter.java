...
public final class LargeParcelTeleporter implements SafeParcelable {
    ...
    class C02501 implements Runnable {
        ...
        C02501(LargeParcelTeleporter largeParcelTeleporter, OutputStream outputStream, byte[] bArr) {
    ...
    public <T extends SafeParcelable> T zza(Creator<T> creator) {
        if (this.zzIs) {
            if (this.zzIq == null) {
                zzb.m9e("File descriptor is empty, returning null.");
                return null;
            }
    ...
    protected <T> ParcelFileDescriptor zzf(byte[] bArr) {
        ...
        try {
            ...
            try {
                new Thread(new C02501(this, autoCloseOutputStream, bArr)).start();
                return createPipe[0];
            } catch (IOException e2) {
                e = e2;
            }
