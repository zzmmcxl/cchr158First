...
public class zzc extends zzim implements ServiceConnection {
    ...
    class C02481 implements Runnable {
        ...
        C02481(zzc com_google_android_gms_ads_internal_purchase_zzc, zzf com_google_android_gms_ads_internal_purchase_zzf, Intent intent) {
    ...
    private void zze(long j) {
        do {
            if (!zzf(j)) {
                zzin.m27v("Timeout waiting for pending transaction to be processed.");
            }
        } while (!this.zzFB);
    }
    ...
    protected void zza(zzf com_google_android_gms_ads_internal_purchase_zzf, String str, String str2) {
        ...
        zzir.zzMc.post(new C02481(this, com_google_android_gms_ads_internal_purchase_zzf, intent));
    }
