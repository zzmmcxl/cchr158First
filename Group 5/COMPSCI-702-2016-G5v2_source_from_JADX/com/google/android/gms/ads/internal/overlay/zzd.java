...
public class zzd extends com.google.android.gms.internal.zzfv.zza implements zzs {
    ...
    class C06991 implements com.google.android.gms.internal.zzjq.zza {
        final /* synthetic */ zzd zzEv;

        C06991(zzd com_google_android_gms_ads_internal_overlay_zzd) {
    ...
    private class zzd extends zzim {
        ...
        class C02471 implements Runnable {
            ...
            C02471(zzd com_google_android_gms_ads_internal_overlay_zzd_zzd, Drawable drawable) {
        ...
        public void zzbr() {
            ...
            if (zzf != null) {
                zzir.zzMc.post(new C02471(this, zzr.zzbE().zza(this.zzEv.mActivity, zzf, this.zzEv.zzEh.zzEM.zzqo, this.zzEv.zzEh.zzEM.zzqp)));
            }
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            this.zzDm.setId(GeofenceStatusCodes.GEOFENCE_NOT_AVAILABLE);
    ...
    protected void zzx(boolean z) throws zza {
        ...
        if (z) {
            ...
            this.zzpD.zzhU().zza(new C06991(this));
