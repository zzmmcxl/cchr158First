...
public abstract class zzc extends zzb implements zzg, zzft {
    ...
    class C02572 implements Runnable {
        ...
        C02572(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzif_zza) {
    ...
    class C02603 implements Runnable {
        ...
        class C02581 implements OnTouchListener {
            ...
            final /* synthetic */ C02603 zzpv;

            C02581(C02603 c02603, zze com_google_android_gms_ads_internal_zze) {
                this.zzpv = c02603;
        ...
        class C02592 implements OnClickListener {
            ...
            C02592(C02603 c02603, zze com_google_android_gms_ads_internal_zze) {
                this.zzpv = c02603;
                this.zzpu = com_google_android_gms_ads_internal_zze;
            }
        ...
        C02603(zzc com_google_android_gms_ads_internal_zzc, zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
            this.zzpr = com_google_android_gms_ads_internal_zzc;
            this.zzps = com_google_android_gms_internal_zzif_zza;
        ...
        public void run() {
            ...
            zza.setOnTouchListener(new C02581(this, com_google_android_gms_ads_internal_zze));
            zza.setOnClickListener(new C02592(this, com_google_android_gms_ads_internal_zze));
    ...
    class C07051 implements zzdf {
        final /* synthetic */ zzc zzpr;

        C07051(zzc com_google_android_gms_ads_internal_zzc) {
            this.zzpr = com_google_android_gms_ads_internal_zzc;
        }
    ...
    protected void zza(zzeh com_google_android_gms_internal_zzeh) {
        com_google_android_gms_internal_zzeh.zza("/trackActiveViewUnit", new C07051(this));
    }
    ...
    protected void zza(zza com_google_android_gms_internal_zzif_zza, zzcb com_google_android_gms_internal_zzcb) {
        if (com_google_android_gms_internal_zzif_zza.errorCode != -2) {
            zzir.zzMc.post(new C02572(this, com_google_android_gms_internal_zzif_zza));
            return;
        }
        ...
        if (!com_google_android_gms_internal_zzif_zza.zzLe.zzHT || com_google_android_gms_internal_zzif_zza.zzLe.zzum) {
            zzir.zzMc.post(new C02603(this, com_google_android_gms_internal_zzif_zza, com_google_android_gms_internal_zzcb));
            return;
        }
        this.zzpj.zzrL = 0;
