...
public class zzk extends FrameLayout implements zzh {
    ...
    private void zzfJ() {
        if (this.zzpD.zzhP() != null && !this.zzEQ) {
            this.zzER = (this.zzpD.zzhP().getWindow().getAttributes().flags & Barcode.ITF) != 0;
            if (!this.zzER) {
                this.zzpD.zzhP().getWindow().addFlags(Barcode.ITF);
                this.zzEQ = true;
            }
        }
    }
    ...
    private void zzfK() {
        if (this.zzpD.zzhP() != null && this.zzEQ && !this.zzER) {
            this.zzpD.zzhP().getWindow().clearFlags(Barcode.ITF);
            this.zzEQ = false;
        }
    }
