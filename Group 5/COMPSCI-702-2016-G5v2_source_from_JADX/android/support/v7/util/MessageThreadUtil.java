...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C06741 implements MainThreadCallback<T> {
        ...
        class C01781 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = C06741.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case C06741.UPDATE_ITEM_COUNT /*1*/:
                            C06741.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case C06741.ADD_TILE /*2*/:
                            C06741.this.val$callback.addTile(msg.arg1, (Tile) msg.data);
                            break;
                        case C06741.REMOVE_TILE /*3*/:
                            C06741.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = C06741.this.mQueue.next();
                }
            }
        }

        C06741(MainThreadCallback mainThreadCallback) {
            this.val$callback = mainThreadCallback;
            this.mQueue = new MessageQueue();
            this.mMainThreadHandler = new Handler(Looper.getMainLooper());
            this.mMainThreadRunnable = new C01781();
        }
    ...
    class C06752 implements BackgroundCallback<T> {
        ...
        class C01791 implements Runnable {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = C06752.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case C06752.REFRESH /*1*/:
                                C06752.this.mQueue.removeMessages(C06752.REFRESH);
                                C06752.this.val$callback.refresh(msg.arg1);
                                break;
                            case C06752.UPDATE_RANGE /*2*/:
                                C06752.this.mQueue.removeMessages(C06752.UPDATE_RANGE);
                                C06752.this.mQueue.removeMessages(C06752.LOAD_TILE);
                                C06752.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case C06752.LOAD_TILE /*3*/:
                                C06752.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case C06752.RECYCLE_TILE /*4*/:
                                C06752.this.val$callback.recycleTile((Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
                    ...
                    C06752.this.mBackgroundRunning.set(false);
                    return;
                }
            }
        }

        C06752(BackgroundCallback backgroundCallback) {
            ...
            this.mBackgroundRunnable = new C01791();
        }
