...
public class AsyncListUtil<T> {
    ...
    class C06721 implements MainThreadCallback<T> {
        C06721() {
        }
    ...
    class C06732 implements BackgroundCallback<T> {
    ...
    public AsyncListUtil(Class<T> klass, int tileSize, DataCallback<T> dataCallback, ViewCallback viewCallback) {
        ...
        this.mMainThreadCallback = new C06721();
        this.mBackgroundCallback = new C06732();
        this.mTClass = klass;
