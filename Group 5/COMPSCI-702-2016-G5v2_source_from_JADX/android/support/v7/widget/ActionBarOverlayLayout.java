...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C09411 extends ViewPropertyAnimatorListenerAdapter {
        C09411() {
        }
    ...
    static {
        ATTRS = new int[]{C0161R.attr.actionBarSize, 16842841};
    }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C09411();
        this.mRemoveActionBarHideOffset = new C01822();
        this.mAddActionBarHideOffset = new C01833();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0161R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0161R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0161R.id.action_bar));
        }
    }
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, LinearLayoutManager.INVALID_OFFSET, Strategy.TTL_SECONDS_INFINITE);
