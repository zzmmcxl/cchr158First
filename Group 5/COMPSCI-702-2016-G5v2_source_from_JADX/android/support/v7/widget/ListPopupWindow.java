...
public class ListPopupWindow {
    ...
    class C02013 implements OnItemSelectedListener {
        C02013() {
        }
    ...
    class C06801 extends ForwardingListener {
        C06801(View x0) {
            super(x0);
        }
    ...
    private static class DropDownListView extends ListViewCompat {
        ...
        public DropDownListView(Context context, boolean hijackFocus) {
            super(context, null, C0161R.attr.dropDownListViewStyle);
    ...
    public ListPopupWindow(Context context, AttributeSet attrs) {
        this(context, attrs, C0161R.attr.listPopupWindowStyle);
    }
    ...
    public ListPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mDropDownWindowLayoutType = Place.TYPE_ADMINISTRATIVE_AREA_LEVEL_2;
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0161R.styleable.ListPopupWindow, defStyleAttr, defStyleRes);
        this.mDropDownHorizontalOffset = a.getDimensionPixelOffset(C0161R.styleable.ListPopupWindow_android_dropDownHorizontalOffset, POSITION_PROMPT_ABOVE);
        this.mDropDownVerticalOffset = a.getDimensionPixelOffset(C0161R.styleable.ListPopupWindow_android_dropDownVerticalOffset, POSITION_PROMPT_ABOVE);
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C02002();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C02013());
