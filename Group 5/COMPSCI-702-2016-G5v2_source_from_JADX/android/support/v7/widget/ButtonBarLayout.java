...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, C0161R.styleable.ButtonBarLayout);
        this.mAllowStacking = ta.getBoolean(C0161R.styleable.ButtonBarLayout_allowStacking, false);
        ta.recycle();
    }
    ...
    private void setStacked(boolean stacked) {
        ...
        View spacer = findViewById(C0161R.id.spacer);
        if (spacer != null) {
