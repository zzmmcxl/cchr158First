...
import android.support.v7.recyclerview.C0177R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static class C02043 implements Interpolator {
        C02043() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, AccessibilityNodeInfoCompat info) {
            ...
            if (ViewCompat.canScrollVertically(this.mRecyclerView, RecyclerView.VERTICAL) || ViewCompat.canScrollHorizontally(this.mRecyclerView, RecyclerView.VERTICAL)) {
                info.addAction((int) Barcode.AZTEC);
                info.setScrollable(true);
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0177R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0177R.styleable.RecyclerView_android_orientation, RecyclerView.VERTICAL);
            properties.spanCount = a.getInt(C0177R.styleable.RecyclerView_spanCount, RecyclerView.VERTICAL);
            properties.reverseLayout = a.getBoolean(C0177R.styleable.RecyclerView_reverseLayout, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            properties.stackFromEnd = a.getBoolean(C0177R.styleable.RecyclerView_stackFromEnd, RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST);
            a.recycle();
            return properties;
        }
        ...
        View getViewForPosition(int position, boolean dryRun) {
            ...
            if (fromScrap && !RecyclerView.this.mState.isPreLayout() && holder.hasAnyOfTheFlags(AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD)) {
                ...
                if (RecyclerView.this.mState.mRunSimpleAnimations) {
                    RecyclerView.this.recordAnimationInfoIfBouncedHiddenView(holder, RecyclerView.this.mItemAnimator.recordPreLayoutInformation(RecyclerView.this.mState, holder, ItemAnimator.buildAdapterChangeFlagsForAnimations(holder) | Barcode.AZTEC, holder.getUnmodifiedPayloads()));
                }
            }
    ...
    private class ViewFlinger implements Runnable {
        ...
        public void fling(int velocityX, int velocityY) {
            ...
            this.mScroller.fling(RecyclerView.TOUCH_SLOP_DEFAULT, RecyclerView.TOUCH_SLOP_DEFAULT, velocityX, velocityY, LinearLayoutManager.INVALID_OFFSET, Strategy.TTL_SECONDS_INFINITE, LinearLayoutManager.INVALID_OFFSET, Strategy.TTL_SECONDS_INFINITE);
            postOnAnimation();
        }
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            if (velocity > 0) {
                ...
                duration = (int) (((((float) absDx) / ((float) containerSize)) + TextTrackStyle.DEFAULT_FONT_SCALE) * BitmapDescriptorFactory.HUE_MAGENTA);
            }
    ...
    static {
        ...
        sQuinticInterpolator = new C02043();
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02021();
        ...
        this.mItemAnimatorRunner = new C02032();
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, C0177R.styleable.RecyclerView, defStyle, TOUCH_SLOP_DEFAULT);
            String layoutManagerName = a.getString(C0177R.styleable.RecyclerView_layoutManager);
            a.recycle();
    ...
    private void dispatchContentChangedIfNecessary() {
        ...
        if (flags != 0 && isAccessibilityEnabled()) {
            ...
            event.setEventType(Barcode.PDF417);
