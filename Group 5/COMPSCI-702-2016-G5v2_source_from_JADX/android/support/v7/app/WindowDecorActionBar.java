...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C06663 implements ViewPropertyAnimatorUpdateListener {
        C06663() {
        }
    ...
    class C09381 extends ViewPropertyAnimatorListenerAdapter {
        C09381() {
        }
    ...
    class C09392 extends ViewPropertyAnimatorListenerAdapter {
        C09392() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C09381();
        this.mShowListener = new C09392();
        this.mUpdateListener = new C06663();
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0161R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0161R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0161R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0161R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0161R.styleable.ActionBar, C0161R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0161R.styleable.ActionBar_hideOnContentScroll, ALLOW_SHOW_HIDE_ANIMATIONS)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0161R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0161R.attr.actionBarWidgetTheme, outValue, true);
