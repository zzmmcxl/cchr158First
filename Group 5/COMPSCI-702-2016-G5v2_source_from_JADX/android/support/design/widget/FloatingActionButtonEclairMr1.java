...
class FloatingActionButtonEclairMr1 extends FloatingActionButtonImpl {
    ...
    class C06171 extends AnimationListenerAdapter {
        final /* synthetic */ boolean val$fromUser;
        final /* synthetic */ InternalVisibilityChangedListener val$listener;

        C06171(boolean z, InternalVisibilityChangedListener internalVisibilityChangedListener) {
            this.val$fromUser = z;
    ...
    class C06182 extends AnimationListenerAdapter {
        final /* synthetic */ InternalVisibilityChangedListener val$listener;

        C06182(InternalVisibilityChangedListener internalVisibilityChangedListener) {
            this.val$listener = internalVisibilityChangedListener;
        }
    ...
    void hide(@Nullable InternalVisibilityChangedListener listener, boolean fromUser) {
        if (!this.mIsHiding && this.mView.getVisibility() == 0) {
            ...
            anim.setAnimationListener(new C06171(fromUser, listener));
    ...
    void show(@Nullable InternalVisibilityChangedListener listener, boolean fromUser) {
        if (this.mView.getVisibility() != 0 || this.mIsHiding) {
            ...
            anim.setAnimationListener(new C06182(listener));
            this.mView.startAnimation(anim);
        } else if (listener != null) {
            listener.onShown();
        }
