...
class FloatingActionButtonIcs extends FloatingActionButtonEclairMr1 {
    ...
    void show(@Nullable InternalVisibilityChangedListener listener, boolean fromUser) {
        ...
        this.mView.animate().scaleX(TextTrackStyle.DEFAULT_FONT_SCALE).scaleY(TextTrackStyle.DEFAULT_FONT_SCALE).alpha(TextTrackStyle.DEFAULT_FONT_SCALE).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00062(fromUser, listener));
    }
