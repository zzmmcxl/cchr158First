...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        class C06271 implements AnimatorUpdateListener {
            ...
            C06271(int i, int i2, int i3, int i4) {
        ...
        class C09312 extends AnimatorListenerAdapter {
        ...
        void animateIndicatorToPosition(int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setUpdateListener(new C06271(startLeft, targetLeft, startRight, targetRight));
                animator.setListener(new C09312(position));
                animator.start();
            }
        }
    ...
    class C06261 implements AnimatorUpdateListener {
        C06261() {
        }
        ...
        if (newPosition != INVALID_WIDTH) {
            ...
            if (startScrollX != targetScrollX) {
                if (this.mScrollAnimator == null) {
                    ...
                    this.mScrollAnimator.setUpdateListener(new C06261());
                }
