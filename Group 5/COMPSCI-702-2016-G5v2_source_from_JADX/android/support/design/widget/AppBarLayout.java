...
public class AppBarLayout extends LinearLayout {
    ...
    class C06071 implements OnApplyWindowInsetsListener {
        C06071() {
        }
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        protected static class SavedState extends BaseSavedState {
            ...
            static class C06091 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C06091() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C06091());
            }
        }

        /* renamed from: android.support.design.widget.AppBarLayout.Behavior.1 */
        class C06081 implements AnimatorUpdateListener {
            final /* synthetic */ AppBarLayout val$child;
            final /* synthetic */ CoordinatorLayout val$coordinatorLayout;

            C06081(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
        ...
        private void animateOffsetTo(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset) {
            ...
            if (currentOffset != offset) {
                if (this.mAnimator == null) {
                    ...
                    this.mAnimator.setUpdateListener(new C06081(coordinatorLayout, child));
                } else {
                    this.mAnimator.cancel();
                }
                this.mAnimator.setDuration(Math.round((1000.0f * (((float) Math.abs(currentOffset - offset)) / coordinatorLayout.getResources().getDisplayMetrics().density)) / BitmapDescriptorFactory.HUE_MAGENTA));
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C06071());
    }
