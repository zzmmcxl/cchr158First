...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C06121 implements OnApplyWindowInsetsListener {
        C06121() {
        }
    ...
    class C06132 implements AnimatorUpdateListener {
        C06132() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C06121());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.setUpdateListener(new C06132());
