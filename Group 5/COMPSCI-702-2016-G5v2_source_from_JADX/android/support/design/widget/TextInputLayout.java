...
public class TextInputLayout extends LinearLayout {
    ...
    class C06284 implements AnimatorUpdateListener {
        C06284() {
        }
    ...
    class C09322 extends ViewPropertyAnimatorListenerAdapter {
        C09322() {
        }
    ...
    class C09333 extends ViewPropertyAnimatorListenerAdapter {
        final /* synthetic */ CharSequence val$error;

        C09333(CharSequence charSequence) {
        ...
        if (!TextUtils.equals(this.mError, error)) {
            ...
            if (this.mErrorShown) {
                ...
                if (animate) {
                    ...
                    ViewCompat.animate(this.mErrorView).alpha(TextTrackStyle.DEFAULT_FONT_SCALE).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C09322()).start();
                }
            } else if (this.mErrorView.getVisibility() == 0) {
                if (animate) {
                    ViewCompat.animate(this.mErrorView).alpha(0.0f).setDuration(200).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new C09333(error)).start();
                } else {
                    this.mErrorView.setVisibility(4);
                }
            }
    ...
    private void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.setUpdateListener(new C06284());
            }
