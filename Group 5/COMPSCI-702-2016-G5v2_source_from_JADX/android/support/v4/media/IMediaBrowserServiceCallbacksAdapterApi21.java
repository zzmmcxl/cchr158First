...
class IMediaBrowserServiceCallbacksAdapterApi21 {
    ...
    static class Stub {
        ...
        static {
            ...
            r1 = java.lang.Class.forName(r2);	 Catch:{ ClassNotFoundException -> 0x001c, NoSuchMethodException -> 0x0017 }
            r2 = "asInterface";
            r3 = 1;
            r3 = new java.lang.Class[r3];	 Catch:{ ClassNotFoundException -> 0x001c, NoSuchMethodException -> 0x0017 }
            r4 = 0;
            r5 = android.os.IBinder.class;
            r3[r4] = r5;	 Catch:{ ClassNotFoundException -> 0x001c, NoSuchMethodException -> 0x0017 }
            r2 = r1.getMethod(r2, r3);	 Catch:{ ClassNotFoundException -> 0x001c, NoSuchMethodException -> 0x0017 }
            sAsInterfaceMethod = r2;	 Catch:{ ClassNotFoundException -> 0x001c, NoSuchMethodException -> 0x0017 }
        L_0x0016:
            return;
        L_0x0017:
            r0 = move-exception;
    ...
    IMediaBrowserServiceCallbacksAdapterApi21(java.lang.Object r8) {
        ...
        r2 = java.lang.Class.forName(r3);	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r3 = "android.content.pm.ParceledListSlice";
        r1 = java.lang.Class.forName(r3);	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r3 = "asBinder";
        r4 = 0;
        r4 = new java.lang.Class[r4];	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r3 = r2.getMethod(r3, r4);	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r7.mAsBinderMethod = r3;	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r3 = "onConnect";
        r4 = 3;
        r4 = new java.lang.Class[r4];	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r5 = 0;
        r6 = java.lang.String.class;
        r4[r5] = r6;	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r5 = 1;
        ...
        r4[r5] = r6;	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r3 = r2.getMethod(r3, r4);	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r7.mOnConnectMethod = r3;	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r3 = "onConnectFailed";
        r4 = 0;
        r4 = new java.lang.Class[r4];	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r3 = r2.getMethod(r3, r4);	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r7.mOnConnectFailedMethod = r3;	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r3 = "onLoadChildren";
        r4 = 2;
        r4 = new java.lang.Class[r4];	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r5 = 0;
        ...
        r4[r5] = r6;	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r5 = 1;
        r4[r5] = r1;	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r3 = r2.getMethod(r3, r4);	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
        r7.mOnLoadChildrenMethod = r3;	 Catch:{ ClassNotFoundException -> 0x005a, NoSuchMethodException -> 0x0055 }
    L_0x0054:
        return;
    L_0x0055:
        r0 = move-exception;
