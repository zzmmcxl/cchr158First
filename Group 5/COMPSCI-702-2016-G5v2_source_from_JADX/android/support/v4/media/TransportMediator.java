...
public class TransportMediator extends TransportController {
    ...
    class C00692 implements Callback {
        C00692() {
        }
    ...
    class C06431 implements TransportMediatorCallback {
        C06431() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mTransportKeyCallback = new C06431();
        this.mKeyEventCallback = new C00692();
