...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C06531 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C06531() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C06531());
        }
    ...
    class C06524 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == Barcode.AZTEC && ViewPager.this.mAdapter != null) {
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C06524());
    }
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        if (event.getEventType() == Barcode.AZTEC) {
