...
class DonutAnimatorCompatProvider implements AnimatorProvider {
    ...
    private static class DonutFloatValueAnimator implements ValueAnimatorCompat {
        ...
        class C00231 implements Runnable {
            ...
            public void run() {
                float fraction = (((float) (DonutFloatValueAnimator.this.getTime() - DonutFloatValueAnimator.this.mStartTime)) * TextTrackStyle.DEFAULT_FONT_SCALE) / ((float) DonutFloatValueAnimator.this.mDuration);
                if (fraction > TextTrackStyle.DEFAULT_FONT_SCALE || DonutFloatValueAnimator.this.mTarget.getParent() == null) {
                ...
                if (DonutFloatValueAnimator.this.mFraction >= TextTrackStyle.DEFAULT_FONT_SCALE) {
